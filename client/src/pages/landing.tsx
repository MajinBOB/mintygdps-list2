    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="relative container mx-auto px-6 py-24 md:py-32">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-white/90 leading-relaxed">
              Explore the hardest demons, track verified records, and compete
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              <Button
                ...
                data-testid="button-view-demonlist"
              >
                <a href="/demonlist">
                  View Demonlist
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Browse the most challenging demons ranked by difficulty and
                community consensus
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Submit your completions with video proof and get verified by our
                admin team
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Climb the leaderboard and earn points based on your demon
                completions
              </p>
            </div>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Sign in to submit your records, track your progress, and compete
            with the best
          </p>
          <Button
            size="lg"
      ...
      <footer className="border-t py-8 mt-auto">
        <div className="container mx-auto px-6 text-center text-sm text-muted-foreground">
          <p>
            &copy; 2025 MintyGDPS Demonlist. Community-driven MintyGDPS
            rankings.
          </p>
        </div>
      </footer>
